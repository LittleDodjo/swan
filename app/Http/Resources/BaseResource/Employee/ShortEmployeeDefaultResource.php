...
class ShortEmployeeDefaultResource extends JsonResource
{
    ...
    #[Pure] #[ArrayShape(['id' => "mixed", 'deputy_employee' => "\App\Http\Resources\BaseResource\Employee\SmallEmployeeResource", 'reason' => "mixed", 'is_always' => "mixed", 'form_date' => "mixed", 'to_date' => "mixed"])]
